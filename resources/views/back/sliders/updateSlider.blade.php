						...
						<div class="bg-white rounded30 shadow-lg">
							...
							<?php foreach ($errors->all() as $message) {?>
										<p style="color:Red"><?php echo $message?></p>
															...
															@endif
								<form action="{{route('editSliderPost',[$slider->id])}}" method="post" enctype="multipart/form-data">
									@csrf
                                 ...
                                 role="tabpanel" aria-labelledby="pills-tab-{{ $locale->code }}">
									<div class="form-group">
										<div class="input-group mb-3 ">
											...
											<input id="name"  value="{{$slider->setLocale($locale->code)->title}}" required name="title[{{$locale->code}}]" type="" class="form-control pl-15 bg-transparent" placeholder="{{$locale->name}}">
										</div>
										<div class="input-group mb-3 ">
											<div class="input-group-prepend">
												<span class="input-group-text bg-transparent"><i class="ti-tag"></i></span>
											</div>
											<textarea rows="6" id="name"  value="" required name="description[{{$locale->code}}]" type="" class="form-control pl-15 bg-transparent" placeholder="{{$locale->name}}">{{$slider->setLocale($locale->code)->description}}</textarea>
										</div>
										</div>
										</div>
										@endforeach
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input   value="{{$slider->author}}" required name="author" type="" class="form-control pl-15 bg-transparent" placeholder="Author name">
