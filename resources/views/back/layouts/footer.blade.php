...
<!-- ./wrapper -->
	...
	<script src="https://www.multipurposethemes.com/admin/powerbi-admin-template/html/assets/vendor_plugins/iCheck/icheck.js"></script>
	<script src="https://www.multipurposethemes.com/admin/powerbi-admin-template/html/assets/vendor_plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>

	<script src="{{asset('back/')}}/js/pages/mailbox.js"></script>
	<script src="{{asset('back/')}}/js/pages/form-compose.js"></script>
	<!-- Power BI Admin App -->
