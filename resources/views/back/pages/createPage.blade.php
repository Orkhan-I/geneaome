					...
					<div class="col-lg-10 col-md-10 col-12">
						<div class="bg-white rounded30 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								<h2 class="text-primary">Create Page</h2>
								<ul>
							...
							<?php foreach ($errors->all() as $message) {?>
										<p style="color:Red"><?php echo $message?></p>
															...
															@endif
								<form action="{{route('createPagePost')}}"  method="post" enctype="multipart/form-data">
									@csrf
                                 ...
                                 role="tabpanel" aria-labelledby="pills-tab-{{ $locale->code }}">
									<div class="form-group">
										<div class="input-group mb-3 ">
											...
											<input id="name"  value="" required name="title[{{$locale->code}}]" type="" class="form-control pl-15 bg-transparent" placeholder="{{$locale->name}}">
										</div>
