						...
						<div class="bg-white rounded30 shadow-lg">
							...
							<?php foreach ($errors->all() as $message) {?>
										<p style="color:Red"><?php echo $message?></p>
															...
															@endif
								<form action="{{route('createCategoryPost')}}"  method="post" enctype="multipart/form-data">
									@csrf
                                 ...
                                 role="tabpanel" aria-labelledby="pills-tab-{{ $locale->code }}">
									<div class="form-group">
										<div class="input-group mb-3 ">
											...
											<input id="name"  value="" required name="{{$locale->code}}" type="" class="form-control pl-15 bg-transparent" placeholder="{{$locale->name}}">
										</div>
										</div>
										</div>
										@endforeach
