						...
						<div class="bg-white rounded30 shadow-lg">
							...
							<?php foreach ($errors->all() as $message) {?>
										<p style="color:Red"><?php echo $message?></p>
															<?php }?>
								<form action="{{route('createRoles')}}" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input value="" name="name" type="" class="form-control pl-15 bg-transparent" placeholder="Role Name">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input value="" class="form-control pl-15 bg-transparent" name="guard_name" id="" placeholder="Guard Name">
