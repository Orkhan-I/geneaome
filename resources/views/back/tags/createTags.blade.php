					...
					<div class="col-lg-10 col-md-10 col-12">
						<div class="bg-white rounded30 shadow-lg">
							...
							<?php foreach ($errors->all() as $message) {?>
								...
								<form action="{{route('tagPost')}}"  method="post" enctype="multipart/form-data">
									@csrf
                                 ...
                                 role="tabpanel" aria-labelledby="pills-tab-{{ $locale->code }}">
									...
									<div class="form-group">
										<div class="file-loading">
											<input class="form-control pl-15 bg-transparent" id="file-1" type="file" name="tagImage" multiple class="file" data-overwrite-initial="false" data-min-file-count="2">
										</div>
									</div>
