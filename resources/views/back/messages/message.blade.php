				  ...
				  <div class="box">
					...
					<div class="box-body">
					  <div class="mailbox-controls">
						...
						<div class="btn-group">
						  <button onclick="$('#deleteMessage').submit()" type="submit" class="btn btn-primary btn-sm"><i class="ion ion-trash-a"></i></button>
                                ...
                                @foreach ($messages as $message)   
                                    <tr>
                                        ...
                                        <td>
											...
											<a  class="mailbox-subject" href="{{route('showMessage')}}"><b>Messsage</b> - {{\Illuminate\Support\str::limit($message->message,20,'...')}}</a>
                                        </td>
